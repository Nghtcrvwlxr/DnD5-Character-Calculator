    ...
    <>
      ...
      <Main>
        <Routes>
          ...
          <Route path="/proficiencies-selection"
                 element={<h3 style={{ textAlign: "center" }}>Proficiencies selection page</h3>} />
          <Route path="/equipment-selection"
                 element={<h3 style={{ textAlign: "center" }}>Equipment selection page</h3>} />
